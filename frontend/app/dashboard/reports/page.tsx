...
const REPORT_TYPES = [
  {
    ...
    label: "Daily Census",
    icon: Bed,
    description: "Bed occupancy and availability summary",
  },
  {
    id: "bed_utilization",
    label: "Bed Utilization",
    icon: BarChart3,
    description: "Department-level utilization rates",
  },
  {
    id: "turnover_time",
    label: "Turnover Time",
    icon: Clock,
    description: "Cleaning and bed readiness metrics",
  },
  {
    id: "admission_discharge",
    label: "Admission/Discharge Summary",
    icon: Users,
    description: "Patient flow statistics",
  },
];
